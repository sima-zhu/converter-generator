...
public final class GeoPoint {
    ...
    @JsonProperty("crs")
    private com.azure.search.documents.models.CoordinateSystem coordinateSystem;

    private GeoPoint() {
        this.coordinateSystem = com.azure.search.documents.models.CoordinateSystem.create();
    }
     ...
     * @return Add desc
     */
    public static GeoPoint create(double latitude, double longitude, com.azure.search.documents.models.CoordinateSystem coordinateSystem) {
     ...
     */
    public com.azure.search.documents.models.CoordinateSystem getCoordinateSystem() {
        return coordinateSystem;
    }
