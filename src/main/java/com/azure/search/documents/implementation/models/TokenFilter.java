...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(name = "#Microsoft.Azure.Search.DictionaryDecompounderTokenFilter", value = DictionaryDecompounderTokenFilter.class),
    ...
    @JsonSubTypes.Type(name = "#Microsoft.Azure.Search.KeywordMarkerTokenFilter", value = KeywordMarkerTokenFilter.class),
    ...
    @JsonSubTypes.Type(name = "#Microsoft.Azure.Search.PatternCaptureTokenFilter", value = PatternCaptureTokenFilter.class),
    @JsonSubTypes.Type(name = "#Microsoft.Azure.Search.PatternReplaceTokenFilter", value = PatternReplaceTokenFilter.class),
    ...
    @JsonSubTypes.Type(name = "#Microsoft.Azure.Search.StemmerOverrideTokenFilter", value = StemmerOverrideTokenFilter.class),
